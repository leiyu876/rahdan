...
class ArgasReadyAndBalanceExport implements FromCollection, ShouldAutoSize, WithEvents
{
    protected $order_id;
    ...
    public function collection()
    {
        ...
        foreach ($items as $key => $item) {
            ...
            if($item['qty'] != $item['qty_send'] + $item['qty_ready'])
            {
            	...
            	$results[] = array($item['partno'], $item['qty_ready'], $bal);
            }
        }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
            	...
            	$event->sheet->getDelegate()->getStyle('C1:C38')->getFont()->setSize(40);
            },
        ];
    }
}
