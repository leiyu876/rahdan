        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">List of Fatora Unfinish (Bagi)</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                                    ...
                                    <td>
                                        <div class="col-sm-12">
                                            <div class="col-sm-3" style="visibility:{{ $invoice->action->code == 'finish' ? 'hidden' : '' }}">
                                                <a href="{{ route('invoices.changeaction', ['id' => $invoice->id, 'action_code' => 'finish', 'action_url' => 'unfinish' ])}}" class="btn btn-primary" role="button">kalas</a>
                                            </div>
                                            <div class="col-sm-4" style="visibility:{{ $invoice->action->code == 'return' ? 'hidden' : '' }}">
                                                <a href="{{ route('invoices.changeaction', ['id' => $invoice->id, 'action_code' => 'return', 'action_url' => 'unfinish' ])}}" class="btn btn-info" role="button">radja</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
