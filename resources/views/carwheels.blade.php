			...
			<!--End-header-->
				...
				<div class="content">
					...
					<div class="products">
						...
						<div class="section group">
							<div class="grid_1_of_5 images_1_of_5">
								 <img src="{{ asset('custom/images/t1.jpg') }}">
							...
							<div class="grid_1_of_5 images_1_of_5">
								<img src="{{ asset('custom/images/t3.jpg') }}">
								 <h3>Lorem Ipsum is simply </h3>
								 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, in reprehenderit.</p>
								 <h4>$120.00</h4>
							     <div class="button"><span><a href="singlepage.html">Read More</a></span></div>
							...
							<div class="grid_1_of_5 images_1_of_5">
								 <img src="{{ asset('custom/images/t4.jpg') }}">
								 <h3>Lorem Ipsum is simply </h3>
								 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, in reprehenderit.</p>
								 <h4>$500.00</h4>
							     <div class="button"><span><a href="singlepage.html">Read More</a></span></div>
					...
					<div class="products products-secondbox">
						...
						<div class="section group">
							<div class="grid_1_of_5 images_1_of_5">
								 <img src="{{ asset('custom/images/t6.jpg') }}">
								 <h3>Lorem Ipsum is simply </h3>
								 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, in reprehenderit.</p>
							...
							<div class="grid_1_of_5 images_1_of_5">
								 <img src="{{ asset('custom/images/t7.jpg') }}">
								 <h3>Lorem Ipsum is simply </h3>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, in reprehenderit.</p>
