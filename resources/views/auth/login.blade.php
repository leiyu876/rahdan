...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset('custom_adminlte/plugins/iCheck/square/blue.css') }}">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="{{ asset('custom_adminlte/index2.html') }}" method="post">
...
<!-- iCheck -->
<script src="{{ asset('custom_adminlte/plugins/iCheck/icheck.min.js') }}"></script>
<script>
  $(function () {
    $('input').iCheck({
