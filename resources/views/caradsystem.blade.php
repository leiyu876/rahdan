	...
	<body>
		...
		<div class="wrap">
			...
			<div class="sub-header">
				<div class="logo">
					<a href="index.html"><img src="{{ asset('custom/images/logo.png') }}" title="logo" /></a>
				</div>
						...
						<div class="cartires-grids">
							<div class="cartire-grid">
								<div class="cartire-grid-img">
									<img src="{{ asset('custom/images/a1.jpg') }}" title="tries" />
								</div>
							...
							<div class="cartire-grid">
								<div class="cartire-grid-img">
									<img src="{{ asset('custom/images/a2.jpg') }}" title="tries" />
								</div>
								<div class="cartire-grid-info">
									<ul>
										<li><span>New</span> |&nbsp;&nbsp;Available !</li>
							...
							<div class="cartire-grid">
								<div class="cartire-grid-img">
									<img src="{{ asset('custom/images/a3.jpg') }}" title="tries" />
								</div>
								<div class="cartire-grid-info">
									<ul>
										<li><span>New</span> |&nbsp;&nbsp;Available !</li>
							...
							<div class="cartire-grid">
								<div class="cartire-grid-img">
									<img src="{{ asset('custom/images/g6.jpg') }}" title="tries" />
								</div>
								<div class="cartire-grid-info">
									<ul>
										<li><span>New</span> |&nbsp;&nbsp;Available !</li>
			...
			<div class="footer">
				...
				<div class="col_1_of_4 span_1_of_4 footer-lastgrid">
					<h3>Get in touch</h3>
					<ul>
						<li><a href="#"><img src="{{ asset('custom/images/facebook.png') }}" title="facebook" /></a></li>
						<li><a href="#"><img src="{{ asset('custom/images/twitter.png') }}" title="Twiiter" /></a></li>
