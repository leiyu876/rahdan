        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset('custom_adminlte/dist/img/user2-160x160.jpg') }}" class="user-image" alt="User Image">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ asset('custom_adminlte/index.html') }}"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a href="{{ asset('custom_adminlte/index2.html') }}"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
